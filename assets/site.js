document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    zh: {
      ...
      '— GPA 3.63 / 5.0, major rank 6 / 36.': '— GPA 3.63 / 5.0，专业排名 6 / 36。',
      ...
      'Scholarships': '奖学金',
      'First-, Second-, and Third-Class Scholarships': '一等、二等与三等奖学金',
      'Guangdong University of Technology.': '广东工业大学。',
      'Leadership': '学生工作',
      'Outstanding Class Monitor and Student Cadre': '优秀班长与优秀学生干部',
      'Campus leadership and student service recognition.': '校园组织与学生服务方面的荣誉。',
      'Competitions': '竞赛',
